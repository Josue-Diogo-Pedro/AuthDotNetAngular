...
export const routes: Routes = [
    ...
    {path: '', component:MainLayoutComponent, canActivate:[authGuard],
        ...
        children:[
            {path: 'dashboard', component: DashboardComponent}, //add to map routes 
            ...
            {path: 'apply-for-maternity-leave', component: ApplyForMaternityLeaveComponent, data: {claimReq: claimReq.femaleAndTeacher}},
            {path: 'library-members-only', component: LibraryMembersOnlyComponent, data: {claimReq: claimReq.hasLibraryID}},
            {path: 'under10-and-female', component: Under10AndFemaleComponent, data: {claimReq: claimReq.femaleAndeBelow10}},
